...
int main()
{
    /* Veri tipleri ve kullanýlan hafýza boyutlarý
    int(4 bytes) | %d
    double(8 bytes) | %lf
    float(4 bytes) | %f
    char(1 bytes) | %c
    */
/*Veri tipleri ve verilerle basit iþlemler */
...
/*
 Assigment Operator
  =  tanýlama operatörü
 +=  toplayýp yeniden tanýlama operatörü
 -=  çýkarýp yeniden tanýlama operatörü
 *=  çarpýp yeniden tanýlama operatörü
 /=  bölüp yeniden tanýlama operatörü
 %=  kalan alýp yeniden tanýlama operatörü
*/
...
/*
 Comparison Operator
  ==  eþitmi operatörü
  !=  eþit deðilmi operatörü
   >  büyükmü operatörü
   <  küçükmü operatörü
  >=  büyük eþitmi operatörü
  <=  küçük eþitmi operatörü
*/
...
/*
 ...
 !  deðili operatörü (baþýna geldiði durum çýktýsýný (True/False) tam tersine çevirir (1 ise 0,0ise ))
*/
        ...
        printf("%d\n",!(x<56 && y>38));
        printf("%d\n",!(x>100 || y<100));
/*Girilen sayýlarý karþýlaþtýrma programý */
        int numb1;
        int numb2;
...
/*Girilen sayýnýn tek mi çift mi olduðunu bulan program*/
         int x;
...
/*Yaþa göre oy kullanma durumu hesaplama programý */
        int a;
